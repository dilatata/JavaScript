...
insert into dogowner values('dfg', 'dfg@naver.com', 'luke', '1574', 'seoul', 444444444);
...
insert into dog values('bori', 'dfg', 18, 'jindo');
insert into dog values('bori', 'fgh', 30, 'labrador');
...
insert into Booking values(2, 'fgh' , 6, 21/01/13, 21/01/13, 21/01/16, 0, 'bori', 30. 'labrador', 120000);
